  ...
  useGSAP(() => {
    gsap
      .fromTo(
        "#phone-6",
        { autoAlpha: "0" },
        { autoAlpha: "1", scrollTrigger: "#phone-6" }
      )
      .duration(1.6);
    gsap
      .fromTo(
        "#text-6",
        { y: "30%", autoAlpha: "0" },
        { y: "0%", autoAlpha: "100%", scrollTrigger: "#text-6" }
      )
      .duration(1.6);
  });
  return (
    <main className="w-full lg:w-9/12 bg-neutral-900 p-10 lg:p-32 box-border">
      ...
      <div
        id="phone-6"
        className="flex gap-8 p-5 box-border mt-24 justify-center"
      >
      ...
      <div
        id="text-6"
        className="flex flex-col lg:flex-row gap-8 p-5 box-border mt-12 justify-center"
      >
