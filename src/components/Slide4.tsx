...
const Explore = () => {
  return (
    <main className="w-full min-h-screen bg-neutral-950 flex flex-col items-center ">
      ...
      <div className="text-4xl sm:text-7xl font-semibold text-white place-self-start ml-6 sm:ml-64 mt-20 sm:mt-40 mb-20">
        iPhone. <br /> Forged in titanium.
      </div>
      <div className="grid w-full sm:w-8/12 overflow-hidden gap-5 box-border mb-40">
        ...
        <div className="mt-20 sm:mt-0 text-lg sm:text-xl font-medium text-gray-400 p-6 sm:p-20">
          iPhone 15 Pro is{" "}
        ...
        <div className="text-lg sm:text-xl font-medium text-gray-400 p-6 sm:p-20">
