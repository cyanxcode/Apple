const Footer = () => {
  return (
    <footer className="w-full">
      <div className="text-neutral-400 text-3xl sm:text-5xl font-semibold mt-20 sm:mt-44 ml-5 sm:ml-32">
        iPhone
      </div>
      <div className="flex flex-col ml-6 sm:ml-32 sm:mt-24 gap-2 mb-20">
        <div className="text-neutral-500 text-xs mt-10 sm:text-base">
          Explore iPhone
        </div>
